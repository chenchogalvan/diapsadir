...
<body>
    <div class="front-side">
        ...
        <div class="info-grid">
            <div class="name">
                <h4>{{ $slug->name }}</h4>
                <h4>{{ $slug->last_name }}</h4>
                <h5>{{ $slug->speciality }}</h5>
            </div>
            {{-- <div class="addr">
                ...
                <p>Calle,
                    <strong> Saltillo</strong>, Coahuila,
            ...
            <div class="emailId">
                ...
                <p class="email">{{$slug->email}}</p>
                <p class="web" style="margin-bottom: 20px;">
                    <strong>www</strong>.grupodiapsa.
